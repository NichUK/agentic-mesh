...
mode and receives work through a runtime-managed SQLite queue.
...
- Teams/API ingress
- SQLite message queues and operational state
...
The V4 dispatcher reads the SQLite queue, wakes the target role container with
