...
AGENTIC_MESH_RUNTIME_BUILD_CONTEXT=$(linuxch_host_path_or_default "${AGENTIC_MESH_RUNTIME_BUILD_CONTEXT:-}" /home/nich/agentic-mesh)
AGENTIC_MESH_SYSTEM_HOST_PATH=$(linuxch_host_path_or_default "${AGENTIC_MESH_SYSTEM_HOST_PATH:-}" /home/nich/agentic-mesh)
...
AGENTIC_MESH_OTEL_COLLECTOR_CONFIG_HOST_PATH=$(linuxch_host_path_or_default "${AGENTIC_MESH_OTEL_COLLECTOR_CONFIG_HOST_PATH:-}" /home/nich/agentic-mesh/config/otel/collector.yaml)
