...
def _codex_prompt_text(prompt: str, message: AgentMessage) -> str:
    return "\n\n".join(
        [
            ...
            "document, governance, approval, release, or memory tools. Use status.complete with a summary "
            ...
            "or informed.update to Project Manager/Delivery Manager for governance or delivery follow-up. "
