...
class V3Database:
    ...
    def migrate(self) -> None:
        with self.connection:
            ...
            _ensure_column(self.connection, "work_items", "current_phase", "TEXT")
            _ensure_column(self.connection, "work_items", "next_action", "TEXT NOT NULL DEFAULT ''")
            _ensure_column(self.connection, "work_items", "governance_json", "TEXT NOT NULL DEFAULT '{}'")
            _ensure_column(self.connection, "agent_runs", "message_id", "TEXT NOT NULL DEFAULT ''")
            _ensure_column(self.connection, "agent_runs", "work_item_id", "TEXT")
            _ensure_column(self.connection, "agent_runs", "subject", "TEXT NOT NULL DEFAULT ''")
            _ensure_column(self.connection, "agent_runs", "tool_calls_json", "TEXT NOT NULL DEFAULT '[]'")
            _ensure_column(self.connection, "agent_runs", "error", "TEXT")
            _ensure_column(self.connection, "agent_runs", "started_at", "TEXT NOT NULL DEFAULT ''")
            _ensure_column(self.connection, "agent_runs", "completed_at", "TEXT NOT NULL DEFAULT ''")
