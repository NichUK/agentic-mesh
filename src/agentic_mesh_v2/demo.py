    ...
    _run_role(
        ...
        calls=[
            ...
            SafeOutputCall(
                ...
                payload={"message": "Product definition recorded and handed off to Engineering."},
                terminal=True,
            ),
        ],
    )
    ...
    _run_role(
        ...
        calls=[
            ...
            SafeOutputCall(
                role_id="engineering",
                tool_name="status.complete",
                payload={"message": "Implementation evidence recorded and handed off to QA."},
                terminal=True,
            ),
        ],
    )
    ...
    _run_role(
        ...
        calls=[
            ...
            SafeOutputCall(
                role_id="qa-engineer",
                tool_name="status.complete",
                payload={"message": "QA evidence recorded and handed off to Release Manager."},
                terminal=True,
            ),
        ],
    )
